...
public class RequestDataController2 {
    ...
    public ResponseEntity<?> reqPost1(@RequestParam Map<String, Object> data) {
    ...
    public ResponseEntity<?> reqPost2(@RequestParam ReqJsonDto2 dto) {
    ...
    public ResponseEntity<?> reqPost3(@RequestParam("file") MultipartFile file) {
